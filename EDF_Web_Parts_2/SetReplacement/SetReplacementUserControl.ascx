...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SetReplacementUserControl.ascx.cs" Inherits="EDF_Web_Parts_2.SetReplacement.SetReplacementUserControl" %>
...
<table>
    ...
    <tr>
        ...
        <td>
            <SharePoint:PeopleEditor ID="up_rep" runat="server" Width="350" SelectionSet="User" />
            ...
            <div class="content_left fright" style="width:600px;">
                ...
                <div class="request" style="width:540px;">
                    <ul class="sort clearfix" style="height:66px; line-height:60px">
                        ...
                        <li class="clearfix fright"><input runat="server" id="tb_end" type="text" value="Select end date" class="datepicker" style="width:210px; height:30px; margin-right:15px" /></li>
                    </ul>
                </div>    
            </div>         
        </td>
