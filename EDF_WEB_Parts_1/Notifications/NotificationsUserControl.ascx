...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NotificationsUserControl.ascx.cs" Inherits="EDF_WEB_Parts_1.Notifications.NotificationsUserControl" %>
    ...
    <div class="content_left fright">
        ...
        <div class="request">
            ...
            <ul class="clearfix">
                ...
                <li class="sort clearfix" style="height:110px; padding: 5px 20px 5px 20px; line-height:30px">
                    <p class="fleft">Filter by request Autore:</p>
                    <SharePoint:PeopleEditor ID="spPeoplePicker" runat="server" Width="428" SelectionSet="User" />
                </li>
